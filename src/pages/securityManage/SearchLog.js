...
import { searchSecurityList } from '../../api/security/security';
...
class Page extends Component {
  ...
  getPageData = (isPageOne) => {
    ...
    searchSecurityList(reqData).then(res => {
  ...
  columns = [
    ...
    { title: "首次查询时间", dataIndex: "firstQueryTimeSecurity", render: data => data ? dateUtil.getDateTime(data) : "--" },
    { title: "总查询次数", dataIndex: "queryCountSecurity", render: data => data || "--" }
  ]
